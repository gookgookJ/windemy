      ...
      <Link to={`/course/${course.id}`} className="group cursor-pointer block">
        <div className="relative mb-4">
          ...
          <button
            ...
            className="absolute bottom-1 right-1 w-6 h-6 sm:w-8 sm:h-8 lg:w-9 lg:h-9 rounded-full border border-border bg-transparent hover:bg-accent/40 transition-colors duration-200 shadow-sm z-10 flex items-center justify-center"
