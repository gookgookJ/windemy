      ...
      <Link to={`/course/${course.id}`} className="group cursor-pointer block">
        <div className="relative mb-4">
          ...
          <button
            ...
            className="absolute bottom-1 right-1 w-1.5 h-1.5 sm:w-2.5 sm:h-2.5 lg:w-3.5 lg:h-3.5 rounded-full bg-white/90 backdrop-blur-sm hover:bg-white transition-all duration-200 shadow-sm hover:shadow-md hover:scale-110 z-10 touch-target flex items-center justify-center"
