      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6 sm:gap-8 lg:gap-12">
          ...
          <div className="space-y-3 sm:space-y-4 col-span-2 sm:col-span-1">
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <a href="#" className="text-slate-400 hover:text-white transition-colors duration-200 flex items-center gap-2 text-xs sm:text-sm">
          ...
          {/* 네 번째 컬럼 - 커뮤니티 */}
          <div className="space-y-3 sm:space-y-4">
            <h3 className="font-medium text-white text-sm sm:text-base mb-4 sm:mb-6">커뮤니티</h3>
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <a 
                  ...
                  className="text-slate-400 hover:text-white transition-colors duration-200 flex items-center gap-2 text-xs sm:text-sm"
                >
                  <ExternalLink className="w-3 h-3 sm:w-3.5 sm:h-3.5" />
                  네이버 카페
                </a>
        ...
        {/* 하단 회사 정보 */}
        <div className="border-t border-slate-800 mt-8 sm:mt-12 lg:mt-16 pt-6 sm:pt-8">
          <div className="text-xs text-slate-500 space-y-1.5 sm:space-y-2 leading-relaxed">
