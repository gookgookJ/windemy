    ...
    <section className="relative w-full bg-white py-4">
      {hasSlides && (
        <div ref={wrapRef} className="relative w-full overflow-hidden">
          ...
          <div className="absolute bottom-4 left-1/2 transform translate-x-[105px] sm:translate-x-[110px] md:translate-x-[145px] lg:translate-x-[195px] z-[4] flex items-center gap-2">
            <button
