            ...
            <Card className="bg-white/95 backdrop-blur-sm border-0 shadow-xl">
              <CardContent className="p-3">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-base font-bold text-foreground">최신 이커머스 시장 트렌드</h3>
                </div>
                <div className="space-y-1">
                  {bestPosts.slice(0, 4).map((post, index) => (
                    <div key={index} className="group">
                      ...
                      >
                        <span className="flex-shrink-0 w-4 h-4 bg-primary/10 text-primary rounded-full flex items-center justify-center text-xs font-semibold">
                          {index + 1}
                        </span>
                        <span className="text-xs text-foreground/80 group-hover:text-primary transition-colors line-clamp-2">
                          {post.title}
                        </span>
                      </a>
                    </div>
          ...
          <Card className="bg-gradient-to-br from-blue-600 to-blue-700 border-0 shadow-xl text-white">
            <CardContent className="p-3">
              <div className="text-center mb-2">
                <Mail className="h-6 w-6 mx-auto mb-1 text-white/90" />
              ...
              <div className="space-y-2">
                <Input
                  ...
                  className="bg-white/10 backdrop-blur-sm border-white/20 text-white placeholder:text-white/60 text-xs h-8"
                />
                <Button 
                  onClick={handleSubscribe}
                  className="w-full bg-slate-800 hover:bg-slate-900 text-white font-semibold text-xs h-8"
                >
                  구독하기
                </Button>
              </div>
