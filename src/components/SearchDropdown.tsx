    ...
    <div className={cn("relative w-full max-w-md", className)}>
      <div className="relative">
        ...
        <Input
          ...
          className="pl-10 pr-16 bg-muted/50 border-none rounded-xl focus:bg-white focus:shadow-medium transition-all duration-200 placeholder:text-xs md:placeholder:text-sm lg:placeholder:text-base"
        />
        <Button
