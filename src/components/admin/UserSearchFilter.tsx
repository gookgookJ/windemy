      ...
      <CardContent className="space-y-4 pt-6">
        ...
        <div className="flex gap-4">
          <div className="flex-1 relative">
            ...
            <Input
              placeholder="이름, 이메일, 연락처, 회원ID로 검색..."
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 pt-4 border-t">
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="outline" className="w-full justify-start text-left font-normal">
                    {filters.joinDateStart ? format(filters.joinDateStart, 'PPP', { locale: ko }) : "시작일 선택"}
                  </Button>
                </PopoverTrigger>
            ...
            <div className="space-y-2">
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="outline" className="w-full justify-start text-left font-normal">
                    {filters.joinDateEnd ? format(filters.joinDateEnd, 'PPP', { locale: ko }) : "종료일 선택"}
                  </Button>
                </PopoverTrigger>
                <PopoverContent className="w-auto p-0">
                  <Calendar
            ...
            <div className="space-y-2">
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="outline" className="w-full justify-start text-left font-normal">
                    {filters.lastLoginStart ? format(filters.lastLoginStart, 'PPP', { locale: ko }) : "시작일 선택"}
                  </Button>
                </PopoverTrigger>
                <PopoverContent className="w-auto p-0">
                  <Calendar
            ...
            <div className="space-y-2">
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="outline" className="w-full justify-start text-left font-normal">
                    {filters.lastLoginEnd ? format(filters.lastLoginEnd, 'PPP', { locale: ko }) : "종료일 선택"}
                  </Button>
                </PopoverTrigger>
                <PopoverContent className="w-auto p-0">
                  <Calendar
