...
const About = () => {
    // Typing effect, scroll reveal, count-up 로직은 기존과 동일하게 유지합니다.
    // 이 기능들은 이미 훌륭하게 작동하고 있습니다.
    ...
    return (
        <div className="min-h-screen bg-background text-foreground font-sans">
            ...
            {/* Hero Section */}
            <section
                className="relative overflow-hidden border-b border-border bg-white pt-32 pb-24 md:pt-40 md:pb-32 -mt-16 opacity-0 translate-y-8 transition-all duration-700"
                data-animate
            >
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-left">
                    ...
                    <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight text-foreground">
                        ...
                        그러나 성공을 만드는 <span className="text-primary">{currentText}</span>
            ...
            <section className="py-20 md:py-24 lg:py-32 px-4 sm:px-6 lg:px-8" data-animate>
                <div className="max-w-6xl mx-auto text-left">
                    <h2 className="text-base text-primary font-bold tracking-wider mb-3">BY THE NUMBERS</h2>
                    <p className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-foreground leading-tight">
            ...
            <section className="py-20 md:py-24 lg:py-32 px-4 sm:px-6 lg:px-8 bg-gray-50/70">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                        {[
                            ...
                            <div key={principle.title} className="bg-card border border-border rounded-2xl p-8 group hover:border-primary hover:shadow-xl hover:-translate-y-2 transition-all duration-300" data-animate>
                                <div className="flex items-center justify-center w-16 h-16 bg-primary/10 mb-6 rounded-2xl group-hover:bg-primary/20 group-hover:scale-110 transition-all duration-300">
                                    <principle.icon className="w-8 h-8 text-primary" />
                                </div>
                                <h4 className="text-xl font-bold text-foreground mb-3 group-hover:text-primary transition-colors duration-300">{principle.title}</h4>
            ...
            <section className="py-20 md:py-24 lg:py-32 px-4 sm:px-6 lg:px-8">
                <div className="max-w-6xl mx-auto" data-animate>
                    <div className="bg-primary text-primary-foreground rounded-3xl p-8 sm:p-12 md:p-16 flex flex-col lg:flex-row lg:items-center lg:justify-between text-center lg:text-left hover:shadow-2xl transition-shadow duration-300">
                        <div className="mb-8 lg:mb-0">
                            <h2 className="text-3xl md:text-4xl font-bold leading-tight mb-3">이제 당신의 차례입니다.</h2>
                            <p className="text-lg opacity-80 max-w-xl mx-auto lg:mx-0">윈들리아카데미와 함께라면, 경제적 자유는 더 이상 꿈이 아닙니다.</p>
                        </div>
                        <a
                            href="/courses"
                            className="inline-flex items-center justify-center gap-2 bg-background text-foreground font-bold py-4 px-8 rounded-full hover:bg-muted hover:scale-105 transition-all duration-200 hover:-translate-y-1 flex-shrink-0 group self-center lg:self-auto"
                        >
